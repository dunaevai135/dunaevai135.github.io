async function some5() {
    ...
    var response = await fetch("https://isu.ifmo.ru/pls/apex/f?p=2437:110:"+document.querySelector('#pInstance').value+"::NO::");
    var content = await response.text();
    var r1 = content.search('P110_FILE_ID')
    var r2 = content.slice(r1).search('<style>')
    var photo = content.slice(r1, r1+r2)
